 ...
 <span id="e_nombre" class="styerror"></span>
     ...
     <input name="correo" type="text" id="correo" class="correo" placeholder="Email" paceholder_ value="<?php echo $_POST?$_POST['correo']:""; ?>" />
      ...
      <span id="e_fecha" class="styerror"></span>
       <input id="demo1" type="text" name="fecha" class="fecha" placeholder="Fecha de nacimiento" readonly="readonly" value="<?php echo $_POST?$_POST['fecha']:""; ?>" /> 
     ...
     <span id="e_descr" class="styerror"></span>
      <input name="descr" type="text" id="descr" class="descr" placeholder="Descripcion" class="descr" value="<?php echo $_POST?$_POST['descr']:""; ?>" /> 
           ...
           PNG <input type="radio" name="tipo" value="PNG"  class="checkbox1"> 
            ...
            <tr>
             ...
             <div class="checkbox1">
                ...
                <td><input type="checkbox" id= "formato[]" name="formato[]" placeholder= "formato" value="Retrato" class="checkbox1" checked/>Retrato
